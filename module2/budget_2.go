...
// Above the existing return statement, create an if statement.
// In the initializer portion of this statement, read from report[month]. This returns two values.
// Assign the first value to a new variable budget and the second value to a new variable ok.
// On the condition portion of the if statement, use the ok variable. Inside the if statement, return budget.
